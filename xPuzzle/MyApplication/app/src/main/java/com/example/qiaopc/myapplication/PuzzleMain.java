...
import com.example.qiaopc.adapter.GridItemsAdapter;
import com.example.qiaopc.bean.ItemBean;
import com.example.qiaopc.util.GameUtil;
import com.example.qiaopc.util.ImagesUtil;
...
public class PuzzleMain extends AppCompatActivity implements OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("qiaopccc", "mPicPath:" + mPicPath);
        if (mResId != 0) {
        ...
        // 对图片处理
        Log.d("qiaopc", "picSelectedTemp = null ?" + picSelectedTemp);
    ...
    private void initViews() {
        ...
        LayoutParams gridParams = new RelativeLayout.LayoutParams(
